...
static const char __pyx_k_home_andy_scikit_learn_release[] = "/home/andy/scikit-learn-release/scikit-learn/sklearn/metrics/cluster/expected_mutual_info_fast.pyx";
 ...
 */
  ...
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(2, 0, 28, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_andy_scikit_learn_release, __pyx_n_s_expected_mutual_information, 20, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
